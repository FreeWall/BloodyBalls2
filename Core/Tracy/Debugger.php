...
require __DIR__ . '/IBarPanel.php';
require __DIR__ . '/Bar.php';
require __DIR__ . '/BlueScreen.php';
require __DIR__ . '/DefaultBarPanel.php';
require __DIR__ . '/Dumper.php';
require __DIR__ . '/ILogger.php';
require __DIR__ . '/FireLogger.php';
require __DIR__ . '/Helpers.php';
require __DIR__ . '/Logger.php';
require __DIR__ . '/OutputDebugger.php';
...
class Debugger
{
	...
	public static function exceptionHandler($exception, $exit = true)
	{
		...
		if (self::$productionMode) {
			...
			if (Helpers::isHtmlMode()) {
				$logged = empty($e);
				Application::self()->runErrorPresenter();
	 ...
	 * @param  string  $name
	 * @return int   elapsed miliseconds
	 */
