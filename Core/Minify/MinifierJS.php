...
class MinifierJS extends Minifier {
	/**
	 ...
	 * @var string[]
	 */
	protected $keywordsBefore = ['do','in','let','new','var','case','else','enum','void','with','class','const','yield','delete','export','import','public','static','typeof','extends','package','private','function','protected','implements','instanceof'];
	/**
	 * List of JavaScript reserved words that accept a <variable, value, ...>
	 ...
	 * @var string[]
	 */
	protected $keywordsAfter = ['in','public','extends','private','protected','implements','instanceof'];
	/**
