...
Strings.inflect = function(value,inflections){
...
Strings.parseUrl = function(str,array){
...
Strings.removeDiacritics = function(str){
	return str.replace(/[^\u0000-\u007E]/g, function(a){
		return Strings.diacriticsMap[a] || a;
	});
};

Strings.defaultDiacriticsRemovalMap = [
...
Strings.diacriticsMap = {};
for (var i=0; i < Strings.defaultDiacriticsRemovalMap .length; i++){
	var letters = Strings.defaultDiacriticsRemovalMap [i].letters;
